...
MODE = {
       # "glm": {"model": ChatGLMForConditionalGeneration, "tokenizer": ChatGLMTokenizer, "config": ChatGLMConfig,
       ...
       #           "dataset": GLM2PromptDataSet},
        "baichuan2": {"model": AutoModelForCausalLM, "tokenizer": AutoTokenizer, "config": AutoConfig,
                 "dataset": GLM2PromptDataSet},
        "yi2": {"model": AutoModelForCausalLM, "tokenizer": AutoTokenizer, "config": AutoConfig,
                      "dataset": GLM2PromptDataSet}}
